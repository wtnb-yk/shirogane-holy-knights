...
class AlbumRowMapper : RowMapper<Album> {
    ...
    override fun map(row: Row): Album {
        ...
        val musicReleases = parseMusicReleases(row.get("music_releases", String::class.java) ?: "")
    ...
    private fun parseMusicReleases(releasesStr: String): List<MusicRelease> {
