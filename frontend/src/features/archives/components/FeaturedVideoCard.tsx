...
const FeaturedVideoCardComponent = ({ video, index }: FeaturedVideoCardProps) => {
  return (
...
FeaturedVideoCardComponent.displayName = 'FeaturedVideoCard';

export const FeaturedVideoCard = React.memo(FeaturedVideoCardComponent);