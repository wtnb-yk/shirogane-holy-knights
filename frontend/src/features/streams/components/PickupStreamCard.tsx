...
import { Radio, Tag, Star } from 'lucide-react';
...
interface PickupStreamCardProps {
  stream: StreamDto;
  index: number;
}

const PickupStreamCardComponent = ({ stream, index }: PickupStreamCardProps) => {
  return (
...
PickupStreamCardComponent.displayName = 'PickupStreamCard';

export const PickupStreamCard = React.memo(PickupStreamCardComponent);